...
public class System_Management extends JFrame {
    ...
    private void addButtonWithIcon(JPanel panel, JButton button, JLabel icon, String text, String iconPath, int x, int y) {
        button.setBackground(new Color(33, 46, 48));
